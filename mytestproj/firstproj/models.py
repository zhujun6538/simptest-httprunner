...
class TestReport(models.Model):
    ...
    case_count = models.IntegerField(verbose_name='总用例',null=True)
    succeescase_count = models.IntegerField(verbose_name='成功用例',null=True)
    # succees_case = models.ManyToManyField(TestCase,related_name='succees_case_report',verbose_name='成功用例',blank=True)
    failcase_count = models.IntegerField(verbose_name='失败用例',null=True)
    # fail_case = models.ManyToManyField(TestCase, related_name='fail_case_report', verbose_name='失败用例', blank=True)
    step_count = models.IntegerField(verbose_name='总步骤',null=True)
    succeesstep_count = models.IntegerField(verbose_name='成功步骤',null=True)
    # succees_step = models.ManyToManyField(Teststep,related_name='succees_step_report',verbose_name='成功步骤',blank=True)
    failstep_count = models.IntegerField(verbose_name='失败步骤',null=True)
    # fail_step = models.ManyToManyField(Teststep, related_name='fail_step_report', verbose_name='失败步骤', blank=True)
    errorstep_count = models.IntegerField(verbose_name='错误步骤', null=True)
    skipstep_count = models.IntegerField(verbose_name='跳过步骤', null=True)
